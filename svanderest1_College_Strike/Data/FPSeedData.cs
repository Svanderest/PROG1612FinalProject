...
{
    public static class FPSeedData
    {
        public static void Initialize(IServiceProvider serviceProvider)
        {
            using (var context = new svanderest1_College_StrikeContext(serviceProvider.GetRequiredService<DbContextOptions<svanderest1_College_StrikeContext>>()))
            {
