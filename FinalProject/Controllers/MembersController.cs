...
namespace FinalProject.Controllers
{
    public class MembersController : Controller
    {
        ...
        {
            var finalProjectContext = _context.Member.Include(m => m.Assignment);
        ...
        public async Task<IActionResult> Create([Bind("ID,FirstName,LastName,Phone,eMail,AssignmentID")] Member member)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,FirstName,LastName,Phone,eMail,AssignmentID")] Member member)
        {
            if (id != member.ID)
            {
                return NotFound();
